        ...
        <table className="w-full text-left border-collapse relative z-10">
          <thead>
            <tr className="bg-gradient-to-r from-gray-800 to-gray-900 text-yellow-500 shadow-md">
              <th className="py-6 px-8 font-black text-xl w-1/3 tracking-widest uppercase border-b border-gray-700">Feature</th>
              <th className="py-6 px-8 font-black text-xl tracking-widest uppercase border-b border-gray-700">Description</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-800">
            {features.map((item, index) => (
              <tr key={index} className="hover:bg-gray-800/50 transition-colors duration-300">
                <td className="py-5 px-8 font-bold text-gray-300 bg-gray-800/20">{item.label}</td>
                <td className="py-5 px-8 text-gray-400 font-light">{item.desc}</td>
              </tr>
            ))}
          </tbody>
        </table>
