...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 relative border-t-4 border-yellow-500">
      ...
      <a href="https://wa.me/917589045547" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition-colors hover:scale-110 transform z-50">
